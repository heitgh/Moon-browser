...
A próxima correção está sendo validada separadamente: recuperação limitada de páginas travadas, compatibilidade de sessão/OAuth, sondas para Pinterest e TikTok e um padrão visual mais compacto. Consulte a [auditoria de compatibilidade](docs/audits/compatibility-stability-2026-09-14.md) e a [matriz de testes](docs/roadmap/compatibility.md). Isso **não altera os downloads públicos**.
