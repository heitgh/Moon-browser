...
export function createElectronPlatform(services: ElectronPlatformServices): Platform { return { ...services, name: "Moon Desktop", version: "0.5.0-demo.2", type: "desktop", os: process.platform, architecture: process.arch }; }
